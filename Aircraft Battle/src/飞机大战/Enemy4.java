...
public class Enemy4 extends Enemy {
    ...
    public Image[] dieImages = new Image[]{
            Toolkit.getDefaultToolkit().getImage("enemy4_down1.png"),
            Toolkit.getDefaultToolkit().getImage("enemy4_down2.png"),
            Toolkit.getDefaultToolkit().getImage("enemy4_down3.png"),
            Toolkit.getDefaultToolkit().getImage("enemy4_down4.png"),
            Toolkit.getDefaultToolkit().getImage("enemy4_down5.png"),
            Toolkit.getDefaultToolkit().getImage("enemy4_down6.png"),
    };
